...
def main():
    ...
    with open('/workspace/RB4/output/ark_confirmed_songs_with_path.txt', 'w') as f:
        for s in sorted(confirmed_songs.keys()):
            f.write(f"{s},{confirmed_songs[s]}\n")
